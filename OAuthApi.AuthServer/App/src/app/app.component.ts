...
import * as loggInActions from '../core/auth-store/logged-in.actions';
import * as authReadyActions from '../core/auth-store/auth-ready.actions';
    ...
    ngOnInit(): void {
        this.tokens.startupTokenRefresh()
            ...
            () => {
                ...
                console.error(error);
                this.store.dispatch(new loggInActions.NotLoggedInAction());
